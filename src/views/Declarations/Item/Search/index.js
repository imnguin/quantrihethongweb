...
const Search = (props) => {
    ...
    const loadData = async (postData) => {
        ...
        const response = await dispatch(_fetchData(HOSTNAME, 'api/item/search', postData));
        if (!response.iserror) {
